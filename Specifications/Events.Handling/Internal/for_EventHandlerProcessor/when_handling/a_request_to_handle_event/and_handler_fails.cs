...
namespace Dolittle.SDK.Events.Handling.Internal.for_EventHandlerProcessor.when_handling.a_request_to_handle_event
{
    public class and_handler_fails : given.all_dependencies
    {
        ...
        Establish context = () => event_handler.Setup(_ => _.Handle(Moq.It.IsAny<object>(), Moq.It.IsAny<EventType>(), Moq.It.IsAny<EventContext>(), Moq.It.IsAny<CancellationToken>())).Throws(new System.Exception());

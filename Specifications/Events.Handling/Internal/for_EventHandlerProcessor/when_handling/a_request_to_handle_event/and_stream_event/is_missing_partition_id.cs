...
namespace Dolittle.SDK.Events.Handling.Internal.for_EventHandlerProcessor.when_handling.a_request_to_handle_event.and_stream_event
{
    public class is_missing_partition_id : given.all_dependencies
    {
        static EventHandlerResponse response;

        Establish context = () => request.Event.PartitionId = null;

...
public class and_projection_type_has_no_fields : a_converter
{
    static a_projection_type_with_no_fields projection_state;
    static Key key;
    ...
    Establish context = () =>
    {
        projection_state = new a_projection_type_with_no_fields();
        key = "some_key";
    ...
    It should_return_a_projection_with_the_deafult_value_for_the_missing_field = () => result_projection.State.AValue.ShouldEqual(default);
}
...
namespace Dolittle.SDK.Projections.Store.for_ProjectionStore.when_getting_all.typed;

public class and_a_projection_state_is_returned : given.all_dependencies
{
    static Key key;
    static given.a_decorated_projection_type stored_state;
    static ScopedProjectionId scoped_projection_id;
    static IEnumerable<given.a_decorated_projection_type> result;
    ...
    Because of = () => result = projection_store.GetAll<given.a_decorated_projection_type>().GetAwaiter().GetResult();

...
public class a_decorated_projection_type: ProjectionBase
{
...
public class an_undecorated_projection_type: ProjectionBase
{
    public int Value { get; set; }
}

[Projection("33390DB3-1223-4524-BACC-9DD27E7469F9")]
public class a_decorated_projection_type_with_lower_case_property: ProjectionBase
{
    public int value { get; set; }
}
[Projection("22B62AD9-DF91-4630-A3C4-FD420276BFC9", "264C8022-9F88-4320-B483-AF63752AB420")]
public class a_decorated_projection_type_with_scope: ProjectionBase
{
    public int Value { get; set; }
}
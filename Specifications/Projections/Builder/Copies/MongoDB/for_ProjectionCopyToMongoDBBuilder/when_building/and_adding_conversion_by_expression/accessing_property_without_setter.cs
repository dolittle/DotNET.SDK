...
public class accessing_property_without_setter : given.all_dependencies
{
    ...
    Establish context = () =>
    {
        ...
        _propertyPath = nameof(given.read_model_type.APropertyWithoutSetter);
        conversion = Conversion.Guid;
        builder.WithConversion(_ => _.APropertyWithoutSetter, conversion);
    };
    ...
    It should_have_the_conversion = () => copy_definition_result.Conversions.ShouldContainOnly(new KeyValuePair<ProjectionPropertyPath, Conversion>(_propertyPath, conversion));

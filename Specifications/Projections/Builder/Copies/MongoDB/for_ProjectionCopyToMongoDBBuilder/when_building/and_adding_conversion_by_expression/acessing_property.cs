...
public class acessing_property : given.all_dependencies
{
    ...
    Establish context = () =>
    {
        ...
        _propertyPath = nameof(given.read_model_type.AProperty);
        conversion = Conversion.Guid;
        builder.WithConversion(_ => _.AProperty, conversion);
    };

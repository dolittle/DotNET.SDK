...
public class accessing_read_only_field : given.all_dependencies
{
    ...
    Establish context = () =>
    {
        ...
        _propertyPath = nameof(given.read_model_type.ReadOnlyField);
        conversion = Conversion.Guid;
        builder.WithConversion(_ => _.ReadOnlyField, conversion);
    };

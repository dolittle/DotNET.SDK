...
public class and_turning_off_default_conversions : given.all_dependencies
{
    ...
    It should_not_get_default_conversions = () => conversions_from_bson_class_map.Verify(_ => _.BuildFrom<given.read_model_type>(build_results, Moq.It.IsAny<IPropertyConversions>()), Times.Never);

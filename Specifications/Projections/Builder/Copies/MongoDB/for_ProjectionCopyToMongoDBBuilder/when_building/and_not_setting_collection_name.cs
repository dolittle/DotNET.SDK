...
public class and_not_setting_collection_name : given.all_dependencies
{
    ...
    It should_build_conversions_from = () => conversions_from_bson_class_map.Verify(_ => _.TryBuildFrom<given.read_model_type>(build_results, Moq.It.IsAny<PropertyConversions>()), Times.Once);

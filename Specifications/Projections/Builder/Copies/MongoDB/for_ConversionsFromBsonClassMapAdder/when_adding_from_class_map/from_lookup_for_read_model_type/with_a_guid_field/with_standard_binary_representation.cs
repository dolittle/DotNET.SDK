...
public class with_standard_binary_representation : given.all_dependencies
{
    ...
    It should_add_conversion_to_guid_for_guid_field = () => conversions.Verify(_ => _.AddConversion("GuidField", Conversion.GuidAsStandardBinary));

...
public class with_int_64_representation : given.all_dependencies
{
    ...
    It should_add_conversion_to_date_time_for_date_time_field = () => conversions.Verify(_ => _.AddConversion("DateTimeField", Conversion.DateAsInt64));

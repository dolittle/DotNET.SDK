...
public class and_everything_is_ok : given.all_dependencies
{
    ...
    Establish context = () =>
    {
        ...
        first_augmenter
            .Setup(_ => _.BuildFrom<given.projection_type>(Moq.It.IsAny<IClientBuildResults>(), Moq.It.IsAny<ProjectionCopies>(), out copies_result))
            .Returns(true);
        first_augmenter
    ...
    It should_call_first_augmenter_once = () => first_augmenter.Verify(_ => _.BuildFrom<given.projection_type>(build_results, Moq.It.IsAny<ProjectionCopies>(), out Moq.It.Ref<ProjectionCopies>.IsAny), Times.Once);
    It should_call_second_augmenter_once = () => second_augmenter.Verify(_ => _.BuildFrom<given.projection_type>(build_results, Moq.It.IsAny<ProjectionCopies>(), out Moq.It.Ref<ProjectionCopies>.IsAny), Times.Once);

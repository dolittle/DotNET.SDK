...
{
    public class and_second_event_is_invalid : given.uncommitted_aggregate_events_and_a_converter
    {
        static object object_from_serializer;

        static PbCommittedAggregateEvent second_committed_aggregate_event;
        ...
        Establish context = () =>
        {
            second_committed_aggregate_event = new PbCommittedAggregateEvent
            {
                Public = is_public,

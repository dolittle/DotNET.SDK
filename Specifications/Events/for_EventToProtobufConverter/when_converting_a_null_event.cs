...
namespace Dolittle.SDK.Events.for_EventToProtobufConverter
{
    public class when_converting_a_null_event : given.a_converter
    {
        ...
        Because of = () => try_result = converter.TryToProtobuf(null, out converted_uncommitted_events, out exception);

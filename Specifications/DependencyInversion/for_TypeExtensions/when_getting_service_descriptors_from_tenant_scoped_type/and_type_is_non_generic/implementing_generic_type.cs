...
public class implementing_generic_interface : given.the_type
{
    [PerTenant]
    class a_type : given.generic_interface<bool> {}
    ...
    It should_have_the_correct_service_type = () => descriptors[0].ServiceType.ShouldEqual(typeof(given.generic_interface<bool>));
}
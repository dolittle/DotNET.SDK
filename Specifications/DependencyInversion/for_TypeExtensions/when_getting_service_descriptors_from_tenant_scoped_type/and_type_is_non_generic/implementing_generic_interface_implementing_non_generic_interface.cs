...
{
    [PerTenant]
    class a_type : given.generic_interface_implementing_non_generic_interface<string> {}
    ...
    It should_have_one_service_type_be_generic_interface_implementing_non_generic_interface = () => descriptors.Any(_ => _.ServiceType == typeof(given.generic_interface_implementing_non_generic_interface<string>)).ShouldBeTrue();

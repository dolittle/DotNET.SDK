...
public class implementing_non_generic_interface_implementing_generic_interface : given.the_type
{
    [PerTenant]
    class type<T> : given.non_generic_interface_implementing_generic_interface {}
    ...
    It should_have_one_service_type_be_non_generic_interface_implementing_generic_interface = () => descriptors.Any(_ => _.ServiceType == typeof(given.non_generic_interface_implementing_generic_interface)).ShouldBeTrue();

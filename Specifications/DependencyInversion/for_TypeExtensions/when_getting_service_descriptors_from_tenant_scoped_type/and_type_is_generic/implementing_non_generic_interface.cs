...
public class implementing_non_generic_interface : given.the_type
{
    [PerTenant]
    class type<T> : given.non_generic_interface {}
    ...
    It should_have_the_correct_service_type = () => descriptors[0].ServiceType.ShouldEqual(typeof(given.non_generic_interface));
}
...
{
    [PerTenant]
    class type<T> : given.generic_interface_implementing_generic_interface<T> {}
    ...
    It should_have_one_service_type_be_generic_interface_implementing_generic_interface = () => descriptors.Any(_ => _.ServiceType == typeof(given.generic_interface_implementing_generic_interface<>)).ShouldBeTrue();
    It should_have_one_service_type_be_generic_interface = () => descriptors.Any(_ => _.ServiceType == typeof(given.generic_interface<>)).ShouldBeTrue();
}
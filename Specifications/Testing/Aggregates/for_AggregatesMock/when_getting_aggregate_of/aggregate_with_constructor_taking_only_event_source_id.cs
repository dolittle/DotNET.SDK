...
class aggregate_with_constructor_taking_only_event_source_id : given.aggregates_mock_without_services<StatelessAggregateRoot>
{
    Because of = getting_the_aggregate_of;

    It should_get_the_aggregate_of = () => aggregate_of.ShouldBeOfExactType<AggregateOfMock<StatelessAggregateRoot>>();

...
namespace Dolittle.SDK.EventHorizon.for_SubscriptionBuilderForConsumerScope
{
    public class when_building
    {
        ...
        Establish context = () =>
        {
            ...
            builder = new SubscriptionBuilderForConsumerScope(consumer_tenant, producer_microservice, producer_tenant, producer_stream, producer_partition, consumer_scope);
        };

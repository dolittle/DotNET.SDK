...
{
    /// <summary>
    /// Defines a builder to add methods to call on an instance of <typeparamref name="THandlerType"/>.
    /// </summary>
    ...
    public class EventHandlerInstanceBuilder<THandlerType, TEventType>
        where TEventType : IEvent
    {
        readonly EventHandlerBuilder<TEventType> _builder;
        readonly THandlerType _instance;

        internal EventHandlerInstanceBuilder(EventHandlerBuilder<TEventType> builder, THandlerType instance)
        {
            _builder = builder;
            _instance = instance;
        }

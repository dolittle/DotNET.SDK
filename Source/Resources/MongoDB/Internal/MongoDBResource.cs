...
namespace Dolittle.SDK.Resources.MongoDB.Internal
{
    ...
    public class MongoDBResource : MongoDBBaseResource, IMongoDBResource
    {
        ...
        /// <inheritdoc />
        protected override Contracts.GetRequest CreateRequest()
            => new Contracts.GetRequest{CallContext = CreateRequestContext() };

        /// <inheritdoc />
        protected override bool TryGetFailureFromResponse(Contracts.GetMongoDBResponse response, out Failure failure)
        {

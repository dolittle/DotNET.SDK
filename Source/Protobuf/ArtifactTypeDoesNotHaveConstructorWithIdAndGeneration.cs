...
{
    /// <summary>
    /// Exception that gets thrown when the <see cref="Type" /> of an <see cref="IArtifact" /> does not have a constructor where the first parameter is a <see cref="ArtifactId" /> and the second is a <see cref="Generation" />..
    /// </summary>

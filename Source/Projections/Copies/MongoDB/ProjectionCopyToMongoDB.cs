...
/// <param name="CollectionName">The <see cref="MongoDBProjectionCollectionName"/>.</param>
/// <param name="Conversions">The BsonType per field conversions.</param>
public record ProjectionCopyToMongoDB(bool ShouldCopy, MongoDBProjectionCollectionName CollectionName, IEnumerable<PropertyConversion> Conversions)
{
    /// <summary>

...
/// </summary>
public interface IProjectionReadModelTypes : IUniqueBindings<ScopedProjectionId, Type>
{
    /// <summary>
    ...
    /// <returns>The <see cref="ScopedProjectionId" />.</returns>
    ScopedProjectionId GetFor<TProjection>()

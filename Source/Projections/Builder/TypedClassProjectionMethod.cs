...
//     where TEvent : class
// {
//     readonly ProjectionResultTypeSignature<TProjection, TEvent> _method;
//
//     /// <summary>
...
//     public TypedClassProjectionMethod(ProjectionResultTypeSignature<TProjection, TEvent> method, KeySelector keySelector)
//     {
//         _method = method;
...
//     /// <param name="keySelector">The <see cref="Projections.KeySelector" />.</param>
//     public TypedClassProjectionMethod(ProjectionMethodSignature<TProjection, TEvent> method, KeySelector keySelector)
//         : this(
...
//     /// <param name="method">The <see cref="ProjectionMethodSignature{TReadModel,TEvent}" /> method to invoke.</param>
//     /// <param name="keySelector">The <see cref="Projections.KeySelector" />.</param>
//     public TypedClassProjectionMethod(ProjectionMethodEventContextSignature<TProjection, TEvent> method, KeySelector keySelector)
//         : this(
//             (TProjection instanceAndReadModel, TEvent @event, ProjectionContext context) =>
//             {
//                 method(instanceAndReadModel, @event, context.EventContext);
//                 return ProjectionResultType.Replace;
//             },
//             keySelector)
//     {

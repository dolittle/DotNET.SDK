...
namespace Dolittle.SDK.Embeddings.Builder
{
    ...
    public interface IEmbeddingCompareMethod<TReadModel>
        where TReadModel : class, new()
    {
        ...
        Task<Try<UncommittedEvents>> TryCompare(TReadModel receivedState, TReadModel currentState, EmbeddingContext context);
    }
}

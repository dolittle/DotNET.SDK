...
namespace Dolittle.SDK.Embeddings
{
    ...
    /// </summary>
    public class EmbeddingsProjectContext : Value<EmbeddingsProjectContext>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmbeddingsProjectContext"/> class.
        /// </summary>
        ...
        /// <param name="executionContext">The <see cref="ExecutionContext"/> in which the event was committed in.</param>
        public EmbeddingsProjectContext(

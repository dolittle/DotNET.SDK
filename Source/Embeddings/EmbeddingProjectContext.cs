...
public class EmbeddingProjectContext : Value<EmbeddingProjectContext>
{
    ...
    /// <param name="executionContext">The <see cref="Execution.ExecutionContext"/> for this embedding.</param>
    ...
    /// <summary>
    /// Gets the <see cref="Execution.ExecutionContext"/> for this embedding.
    /// </summary>

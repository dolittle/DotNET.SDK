...
namespace Dolittle.SDK.Artifacts
{
    ...
    /// </summary>
    /// <typeparam name="TArtifacts">The <see cref="Type" /> of the <see cref="IArtifacts{TArtifact, TArtifactId}" />.</typeparam>
    ...
    {
        /// <summary>
        /// Build an instance of <see cref="IArtifacts{TArtifact, TArtifactId}" /> for <typeparamref name="TArtifact"/> artifact.
        /// </summary>
        /// <returns>An instance of <see cref="IArtifacts{TArtifact, TArtifactId}" />.</returns>
        TArtifacts Build();
        ...
        /// <returns>The <see cref="ArtifactsBuilderFor{TArtifacts, TArtifact, TArtifactId, TBuilder}" /> for building <see cref="IArtifacts{TArtifact, TArtifactId}" />.</returns>

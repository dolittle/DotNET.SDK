...
namespace Dolittle.SDK.Artifacts
{
    ...
    public abstract class ArtifactsBuilder
    {
        ...
        /// <returns>The <see cref="ArtifactsBuilder" /> for building <see cref="IArtifacts" />.</returns>
        public ArtifactsBuilder Associate<T>(Artifact artifact)
        ...
        /// <returns>The <see cref="ArtifactsBuilder" /> for building <see cref="IArtifacts" />.</returns>
        public ArtifactsBuilder Associate(Type type, ArtifactId artifactId)
        ...
        /// <typeparam name="T">The <see cref="Type" /> that gets associated to an <see cref="Artifact" />.</typeparam>
        /// <returns>The <see cref="ArtifactsBuilder" /> for building <see cref="IArtifacts" />.</returns>
        public ArtifactsBuilder Associate<T>(ArtifactId artifactId)
        ...
        /// <typeparam name="T">The <see cref="Type" /> that gets associated to an <see cref="Artifact" />.</typeparam>
        /// <returns>The <see cref="ArtifactsBuilder" /> for building <see cref="IArtifacts" />.</returns>
        public ArtifactsBuilder Associate<T>(ArtifactId artifactId, Generation generation)
        ...
        /// <param name="generation">The <see cref="Generation" /> of the <see cref="Artifact" />.</param>
        /// <returns>The <see cref="ArtifactsBuilder" /> for building <see cref="IArtifacts" />.</returns>
        public abstract ArtifactsBuilder Associate(Type type, ArtifactId artifactId, Generation generation);
    }
}

...
namespace Dolittle.SDK.Services
{
    ...
    public interface IPerformMethodCalls
    {
        ...
        /// </summary>
        /// <param name="method">The <see cref="IAmADuplexStreamingMethod{TClient, TClientMessage, TServerMessage}">method</see> to call.</param>
        ...
        IObservable<TServerMessage> Call<TClient, TClientMessage, TServerMessage>(IAmADuplexStreamingMethod<TClient, TClientMessage, TServerMessage> method, IObservable<TClientMessage> requests, CancellationToken token)

...
namespace Dolittle.SDK.Events.Store.Converters
{
    ...
    public interface ISerializeEventContent
    {
        ...
        bool TrySerialize(object content, out string json, out Exception error);
        ...
        bool TryDeserialize(EventType eventType, EventLogSequenceNumber sequenceNumber, string json, out object content, out Exception error);
    }
}

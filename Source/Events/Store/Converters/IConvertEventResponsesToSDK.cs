...
namespace Dolittle.SDK.Events.Store.Converters
{
    ...
    public interface IConvertEventResponsesToSDK
    {
        ...
        /// </summary>
        /// <param name="source"><see cref="PbCommitEventsResponse"/>.</param>
        /// <returns>The converted <see cref="CommittedEvents" />.</returns>
        CommittedEvents Convert(PbCommitEventsResponse source);
        ...
        CommittedEvent Convert(PbCommittedEvent source);
    }
}
